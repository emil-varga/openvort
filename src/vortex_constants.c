...
int global_line_injection_polarized =
    0; // whether to inject the vortices in a polarized way, off by default

// Barnes-Hut approximation
int global_use_BH = 0;      // false by default
int global_BH_quadtree = 0; // 3D octree by default
double global_BH_resolution =
    0.1; // maximum allowed ratio of BH box size to distance to center of mass
